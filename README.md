...
- [VISUAL_V2_INTERACTION.md](docs/VISUAL_V2_INTERACTION.md) — proximity, grab/drag physics, settle, long-press charge, spotlight, wake, Field tension, and reduced-motion behavior
...
- [VISUAL_V2_CHOREOGRAPHY.md](docs/VISUAL_V2_CHOREOGRAPHY.md) — scheduler-driven play/stop, downbeat, phrase, silence, re-entry, role, density, and recording choreography
...
- [VISUAL_V2_CHROME.md](docs/VISUAL_V2_CHROME.md) — unified playground chrome, Loop-native icons, role-aware contextual panels, sheets, typography and responsive controls
- [VISUAL_V2_PHASE_13_ACCEPTANCE.md](docs/VISUAL_V2_PHASE_13_ACCEPTANCE.md) — Phase 13 chrome/icon/spatial-control gate
