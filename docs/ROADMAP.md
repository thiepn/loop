...
## Phase 17 — Release Candidate — complete
Packaged and exact-head certified `1.0.0-rc.1`, ran the complete clean-user workflow across Chromium, Firefox, Android Chromium, iPhone WebKit, and iPad WebKit profiles, fixed release blockers, and created the annotated `v1.0.0-rc.1` tag. See [PHASE_17_ACCEPTANCE.md](PHASE_17_ACCEPTANCE.md).
